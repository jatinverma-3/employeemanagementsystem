...
<title>View Current Employees - 5G Infotech</title>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">View Current Employees</h3>
                    </div>
                    <div class="box-body">
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class='btn btn-success' onclick='window.location.href="view-current-emp.php?idid=<?php echo $row["emp_id"] ?>"'>Generate ID Card</button>
...
function deleterecord(oid)
{
    ...
    if(c)
    {
        window.location.href='view-current-emp.php?action=delete&id=' +oid;
    }
}
function setinactive(oid)
{
    ...
    if(c)
    {
        window.location.href='view-current-emp.php?action=inactive&id=' +oid;
    }
}
</script>
