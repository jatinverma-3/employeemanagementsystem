...
<title>View Past Employees - 5G Infotech</title>

<div class="content-wrapper">
    <section class="content-header">
        <h1>View Past Employees</h1>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">View Past Employees</h3>
                    </div>
                    <div class="box-body">
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class='btn btn-success' onclick='window.location.href="view-past-emp.php?idid=<?php echo $row["emp_id"] ?>"'>Generate ID Card</button>
...
function deleterecord(oid)
{
    ...
    if(c)
    {
        window.location.href='view-past-emp.php?action=delete&id=' +oid;
    }
}
function setactive(oid)
{
    ...
    if(c)
    {
        window.location.href='view-past-emp.php?action=active&id=' +oid;
    }
}
</script>
    ...
    switch($_GET['action'])
    {
        ...
        case "active":
            ...
            if(mysqli_query($conn,$s))
            {
                ...
                window.location.href='view-past-emp.php';</script>";
            }else{
                echo "<script>alert('Error:".mysqli_error($conn)."');</script>";
            }
        break;
